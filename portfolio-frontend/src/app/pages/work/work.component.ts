...
export class WorkComponent {
  ...
  readonly projects: Project[] = [
    ...
    { id: 'fs3', title: 'NutriTrack - Calories Counter',
    ...
    { id: 'do1', title: 'Safarica – DevOps Hosting',
      oneLiner: 'Containerized deployment with CI/CD and monitoring. Video walkthrough included.',
      roles: ['devops'], tags: ['Docker', 'Kubernetes', 'Azure', 'CI/CD'],
      metrics: ['Zero downtime'], scope: 'App hosting', duration: '2 weeks',
      link: '/projects/devops-safarica', videoLink: 'https://your-video-url.example/devops-safarica' },
    { id: 'do2', title: 'BarberShop – DevOps Hosting',
      oneLiner: 'Containerized deployment with CI/CD and monitoring. Video walkthrough included.',
      roles: ['devops'], tags: ['Docker', 'Kubernetes', 'Azure', 'CI/CD'],
      metrics: ['Scalable infra'], scope: 'App hosting', duration: '2 weeks',
      link: '/projects/devops-barbershop', videoLink: 'https://your-video-url.example/devops-barbershop' },
    { id: 'do3', title: 'Calories Counter – DevOps Hosting',
      oneLiner: 'Containerized deployment with CI/CD and monitoring. Video walkthrough included.',
      roles: ['devops'], tags: ['Docker', 'Kubernetes', 'Azure', 'CI/CD'],
      metrics: ['Reliable builds'], scope: 'App hosting', duration: '2 weeks',
      link: '/projects/devops-calories', videoLink: 'https://your-video-url.example/devops-calories' },
